module coralogix.com/otel-linux-standalone/e2e

go 1.24.0

require (
	coralogix.com/otel-integration/e2e v0.0.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/xk8stest v0.122.0 // indirect
...
replace coralogix.com/otel-integration/e2e => ../../otel-integration/k8s-helm/e2e-test
