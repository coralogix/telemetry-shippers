...
* [UPGRADE] added custom ecslogattributes processor to the container
* [CHANGE] modified ecs-ec2 container to leverage custom distribution with ecslogattributes processor
