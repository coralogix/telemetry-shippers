...
* [UPGRADE] added custom ecslogresourcedetection processor to the container
* [CHANGE] modified ecs-ec2 container to leverage custom distribution with ecslogresourcedetection processor
