...
var expectedMetrics map[string]bool = map[string]bool{
	...
	"otelcol_process_cpu_seconds_seconds":                  false,
	"otelcol_process_memory_rss_bytes":                     false,
	"otelcol_process_runtime_heap_alloc_bytes_bytes":       false,
	"otelcol_process_runtime_total_alloc_bytes_bytes":      false,
	"otelcol_process_runtime_total_sys_memory_bytes_bytes": false,
	...
	"otelcol_processor_filter_spans.filtered":              false,
