...
var expectedMetrics map[string]bool = map[string]bool{
	...
	"otelcol_exporter_queue_capacity_{batches}":                   false,
	"otelcol_exporter_queue_size_{batches}":                       false,
	"otelcol_exporter_send_failed_log_records_{records}":          false,
	"otelcol_exporter_send_failed_metric_points_{datapoints}":     false,
	"otelcol_exporter_send_failed_spans_{spans}":                  false,
	"otelcol_exporter_sent_log_records_{records}":                 false,
	"otelcol_exporter_sent_metric_points_{datapoints}":            false,
	"otelcol_exporter_sent_spans_{spans}":                         false,
	...
	"otelcol_processor_accepted_metric_points_{datapoints}":       false,
	"otelcol_processor_accepted_log_records_{records}":            false,
	"otelcol_processor_accepted_spans_{spans}":                    false,
	"otelcol_processor_batch_batch_send_size_{units}":             false,
	"otelcol_processor_batch_batch_size_trigger_send_{times}":     false,
	"otelcol_processor_batch_metadata_cardinality_{combinations}": false,
	"otelcol_processor_batch_timeout_trigger_send_{times}":        false,
	"otelcol_processor_filter_spans.filtered_ratio":               false,
	"otelcol_processor_incoming_items_{items}":                    false,
	"otelcol_processor_outgoing_items_{items}":                    false,
	"otelcol_receiver_accepted_log_records_{records}":             false,
	"otelcol_receiver_accepted_metric_points_{datapoints}":        false,
	"otelcol_receiver_accepted_spans_{spans}":                     false,
	"otelcol_receiver_refused_log_records_{records}":              false,
	"otelcol_receiver_refused_metric_points_{datapoints}":         false,
	"otelcol_receiver_refused_spans_{spans}":                      false,
	"otelcol_scraper_errored_metric_points_{datapoints}":          false,
	"otelcol_scraper_scraped_metric_points_{datapoints}":          false,
