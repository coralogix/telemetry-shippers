...
var expectedResourceScopeNames = map[string]bool{
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/processor/resourcedetectionprocessor":                         false,
...
var expectedMetrics map[string]bool = map[string]bool{
	...
	"otelcol.resourcedetection.attributes.detected":             false,
	"otelcol.resourcedetection.detector.duration_seconds":       false,
	"otelcol.resourcedetection.detector.results":                false,
	...
	"otelcol_processor_groupbytrace_incomplete_releases":        false,
	"otelcol_processor_groupbytrace_num_events_in_queue_ratio":  false,
	"otelcol_processor_groupbytrace_num_traces_in_memory_ratio": false,
	"otelcol_processor_groupbytrace_spans_released":             false,
	"otelcol_processor_groupbytrace_traces_evicted":             false,
	"otelcol_processor_groupbytrace_traces_released":            false,
	...
	"system.cpu.logical.count":                                  false,
	...
	"otelcol.k8s.watcher.pod.added":                             false,
	"otelcol.k8s.watcher.pod_cache.size_ratio":                  false,
	"otelcol.k8s.watcher.pod.updated":                           false,
	"otelcol.k8s.watcher.pod.deleted":                           false,
	"calls":                                                     false,
	"duration":                                                  false,
}
...
var optionalExpectedMetrics = map[string]bool{
	...
	// Enabled by default in Collector 0.160.0 when the new k8sattributes telemetry format became beta.
	"otelcol.k8s.watcher.cronjob.added":       false,
	"otelcol.k8s.watcher.cronjob.deleted":     false,
	"otelcol.k8s.watcher.cronjob.updated":     false,
	"otelcol.k8s.watcher.job.added":           false,
	"otelcol.k8s.watcher.job.deleted":         false,
	"otelcol.k8s.watcher.job.updated":         false,
	"otelcol.k8s.watcher.namespace.added":     false,
	"otelcol.k8s.watcher.namespace.deleted":   false,
	"otelcol.k8s.watcher.namespace.updated":   false,
	"otelcol.k8s.watcher.node.added":          false,
	"otelcol.k8s.watcher.node.deleted":        false,
	"otelcol.k8s.watcher.node.updated":        false,
	"otelcol.k8s.watcher.replicaset.added":    false,
	"otelcol.k8s.watcher.replicaset.deleted":  false,
	"otelcol.k8s.watcher.replicaset.updated":  false,
	"otelcol.k8s.watcher.statefulset.added":   false,
	"otelcol.k8s.watcher.statefulset.deleted": false,
	"otelcol.k8s.watcher.statefulset.updated": false,
