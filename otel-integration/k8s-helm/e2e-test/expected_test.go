...
var expectedResourceAttributesHostEntityEvents = map[string]string{
	"service.name":             "opentelemetry-collector",
	"cx.agent.type":            "agent",
	"k8s.cluster.name":         "otel-integration-agent-e2e",
	"cx.otel_integration.name": "coralogix-integration-helm",
	"k8s.node.name":            "otel-integration-agent-e2e-control-plane",
	"os.type":                  "linux",
	// Attributes unique to resourcedetection/entity processor
	"host.id":                "",
	"host.name":              "",
	"host.ip":                "",
	"host.mac":               "",
	...
	"host.cpu.cache.l2.size": "",
	"os.description":         "",
	// Cloud provider attributes from resourcedetection/region
	"cloud.provider":           "azure",
	"cloud.platform":           "azure_vm",
	"cloud.region":             "",
	"cloud.account.id":         "",
	...
	return map[string]struct {
		...
		"test-traces-job": {
			...
			attrs: map[string]expectedValue{
				...
				"k8s.job.name":             newExpectedValue(attributeMatchTypeRegex, "telemetrygen-[a-z0-9]+-traces-job"),
				"k8s.namespace.name":       newExpectedValue(attributeMatchTypeEqual, testNs),
				"k8s.node.name":            newExpectedValue(attributeMatchTypeExist, ""),
				"k8s.pod.name":             newExpectedValue(attributeMatchTypeRegex, "telemetrygen-[a-z0-9]+-traces-job-[a-z0-9]+"),
			},
		},
		"test-traces-statefulset": {
			...
			attrs: map[string]expectedValue{
				...
				"k8s.namespace.name":       newExpectedValue(attributeMatchTypeEqual, testNs),
				"k8s.node.name":            newExpectedValue(attributeMatchTypeExist, ""),
				"k8s.pod.name":             newExpectedValue(attributeMatchTypeRegex, "telemetrygen-[a-z0-9]+-traces-statefulset-0"),
				"k8s.statefulset.name":     newExpectedValue(attributeMatchTypeRegex, "telemetrygen-[a-z0-9]+-traces-statefulset"),
			},
		},
		"test-traces-deployment": {
			...
			attrs: map[string]expectedValue{
				"cx.otel_integration.name": newExpectedValue(attributeMatchTypeEqual, "coralogix-integration-helm"),
				"k8s.cluster.name":         newExpectedValue(attributeMatchTypeEqual, "otel-integration-agent-e2e"),
				"k8s.deployment.name":      newExpectedValue(attributeMatchTypeRegex, "telemetrygen-[a-z0-9]+-traces-deployment"),
				"k8s.namespace.name":       newExpectedValue(attributeMatchTypeEqual, testNs),
				"k8s.node.name":            newExpectedValue(attributeMatchTypeExist, ""),
				"k8s.pod.name":             newExpectedValue(attributeMatchTypeRegex, "telemetrygen-[a-z0-9]+-traces-deployment-[a-z0-9]+-[a-z0-9]+"),
			},
		},
		"test-traces-daemonset": {
			...
			attrs: map[string]expectedValue{
				"cx.otel_integration.name": newExpectedValue(attributeMatchTypeEqual, "coralogix-integration-helm"),
				"k8s.cluster.name":         newExpectedValue(attributeMatchTypeEqual, "otel-integration-agent-e2e"),
				"k8s.daemonset.name":       newExpectedValue(attributeMatchTypeRegex, "telemetrygen-[a-z0-9]+-traces-daemonset"),
				"k8s.namespace.name":       newExpectedValue(attributeMatchTypeEqual, testNs),
				"k8s.node.name":            newExpectedValue(attributeMatchTypeExist, ""),
				"k8s.pod.name":             newExpectedValue(attributeMatchTypeRegex, "telemetrygen-[a-z0-9]+-traces-daemonset-[a-z0-9]+"),
			},
		},
	}
}
