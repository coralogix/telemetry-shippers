...
declare -a TEST_CONFIGS=(
    ...
    "TestE2E_InstrumentationWebhookNoCRDs:./values.yaml ./e2e-test/testdata/values-e2e-test.yaml ./e2e-test/testdata/values-e2e-instrumentation-webhook.yaml:component=agent-collector:"
)
