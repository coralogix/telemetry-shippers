...
log_test "=== Running All E2E Tests Sequentially ==="
...
main() {
    ...
    declare -a test_configs=(
        "TestE2E_SpanSanitization:./values.yaml ./e2e-test/testdata/values-e2e-test.yaml ./e2e-test/testdata/values-e2e-cluster-collector.yaml ./e2e-test/testdata/values-e2e-spanmetrics-sanitization.yaml:component=agent-collector:"
        "TestE2E_ClusterCollector_Metrics:./values.yaml ./e2e-test/testdata/values-e2e-test.yaml ./e2e-test/testdata/values-e2e-cluster-collector.yaml ./e2e-test/testdata/values-e2e-spanmetrics-sanitization.yaml:component=agent-collector:"
